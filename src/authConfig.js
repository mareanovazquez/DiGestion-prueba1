...
export const b2cPolicies = {
    ...
    authorityDomain: 'mesatecnica.b2clogin.com',
};
...
export const msalConfig = {
    auth: {
        clientId: '95e2a0c3-52b2-402b-a56d-e752a778a7ba', // This is the ONLY mandatory field that you need to supply.
...
export const protectedResources = {
    apiTodoList: {
        endpoint: 'http://10.10.49.124/api/proveedores',
        scopes: {
            read: ['https://mesatecnica.onmicrosoft.com/digestion-api/digestion.read'],
            write: ['https://mesatecnica.onmicrosoft.com/digestion-api/digestion.write'],
        },
    },
};
