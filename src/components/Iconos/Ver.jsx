export const Ver = () => {
    ...
    return (
        <>
            <div className="text-center"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-file-earmark-ruled-fill" viewBox="0 0 16 16">
